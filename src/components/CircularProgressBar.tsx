...
const CircularProgressBar = ({ percentage }: { percentage: any })=> {
    ...
    <div className="relative flex flex-col items-center w-60 h-40">
      ...
      <div className="mt-4 flex flex-col space-y-2">
        <div className="flex flex-col items-center">
          <span className="text-black-300  capitalize text-xs font-semibold">Listing Optimization Score</span>
          <span className="font-bold text-black-300">{percentage}%</span>
        </div>
        <div className="flex flex-col items-center">
          <span className="text-[#00CC00] text-xs font-semibold">Listing Optimization Opportunity</span>
