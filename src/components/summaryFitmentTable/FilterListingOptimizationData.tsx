...
import CategoryListingOptimizationFilter from "./CategoryListingOptimizationFilter";
import { useDispatch} from "react-redux";
import {setSelectedSite, setResetFilter, setSelectedPath, setSelectedCategory} from "../../Redux/features/fitmentScoreSlice";
import HomeButton from "../summaryTable/HomeButton";

const FilterListingOptimizationData: React.FC<FilterDataProps> = ({
  categories,
  filter,
  setFilter,
  fetchSummaryFitment,
  ...
  return (
    ...
    >
      <div className="flex gap-5 flex-wrap items-end justify-start">
        ...
        <CategoryListingOptimizationFilter
          filter={filter}
          setFilter={setFilter}
...
export default FilterListingOptimizationData;
