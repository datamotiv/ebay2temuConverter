...
import shopifyLogo from "../assets/images/allegro-logo.png"
import {
  Table,
  TableBody,
  TableCell,
    ...
    >
      ...
      <div className="p-[25px] ">
        <div className="flex gap-[30px] flex-row">
          ...
          {!isToggle ? (
            <div
              className={`border border-borderColor rounded-[15px] p-[25px] min-h-[350px] mb-10 bg-[#F2F2F2] ${
              ...
              <>
                <div className="flex justify-between  w-full mb-6">
                  ...
                  <p className="text-lg text-[#0F0C22] font-poppins font-medium">
                   <img src={shopifyLogo} alt="ebay Logo" width={80} height={30} />
                  </p>
...
export default DashboardAllegro;