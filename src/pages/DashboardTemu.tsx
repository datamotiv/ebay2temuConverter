...
import shopifyLogo from "../assets/images/temu-logo.png"
import {
  Table,
  TableBody,
  TableCell,
...
const DashboardTemu = () => {
  ...
  {
    date: '30/05/2025 19:24',
    description: 'Optimize Listings Request',
    status: 'Not Started',
    action: 'View'
  },
  {
    date: '01/06/2025 15:04',
    description: 'Download Listings',
    status: 'Pending',
    action: 'View'
  },
//   {
    ...
    >
      ...
      <div className="p-[25px] ">
        <div className="flex gap-[30px] flex-row">
          ...
          {!isToggle ? (
            <div
              className={`border border-borderColor rounded-[15px] p-[25px] min-h-[350px] mb-10 bg-[#FFF1E0] ${
                isToggle ? "min-w-[950px]" : "min-w-[650px]"
              } static z-[0]`}
            >
              <>
                <div className="flex justify-between items-center w-full mb-0 mt-0">
                  {/* eBay Seller Details (Left) */}
                  <p className="text-lg text-[#0F0C22] font-poppins font-medium">
                   <img src={shopifyLogo} alt="ebay Logo" width={80} height={20} />
                  </p>
