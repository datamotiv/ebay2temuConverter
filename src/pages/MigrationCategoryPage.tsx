...
import {
  ...
  IFilter,
  levelObj,
} from "../../src/components/summaryFitmentTable/helper";
import { useMemo, useState } from "react";
import FilterListingOptimizationData from "../../src/components/summaryFitmentTable/FilterListingOptimizationData";
...
const MigrationCategoryPage: React.FC<SummaryFitmentTableProps> = ({ fetchSummaryFitment, setPaginationCurrentPage })=> {
  ...
  `/migration-listing-page/${searchResultId}/${categoryId}/${site}`,
  {
    ...
    //   ids: filteredListings.map((item: any) => item.id),
    },
  }
);
  };
...
export default MigrationCategoryPage;
